...
function events_check_config() {
	...
	if ( !$template = get_option('events_template') ) {
		...
		$template['page_template'] 			= '<p><strong>%title%</strong><br>%startdate% %starttime%</p>';
		$template['page_h_template'] 		= '<h2>%category%</h2>';
		$template['page_title_default']		= __('Important events', 'wpevents');
		$template['page_f_template'] 		= '';
		$template['archive_template'] 		= '<p><strong>%title%</strong><br>%startdate% %starttime%</p>';
		...
		$template['calendar_template'] 		= '<p><strong>%title%</strong><br>%startdate% %starttime%</p>';
